...
background = scale(load_image("assets\\images\\background\\woodfloor.jpg"), RES)
background.set_alpha(200)

card = {
    'front': scale(load_image("assets\\images\\card_empty.png"), (200, 300)),
    'back': scale(load_image("assets\\images\\card_back.png"), (200, 300))
}
player = scale(load_image("assets\\images\\unknown\\eldenring.png"), (200, 350))
guard = scale(load_image("assets\\images\\unknown\\stickman.png"), (100, 200))
vignette = scale(load_image("assets\\images\\background\\vignette.png"), (RES[0] * 2.5, RES[1]))

select = load_image("assets\\images\\icon\\select_circle_dot.png")
