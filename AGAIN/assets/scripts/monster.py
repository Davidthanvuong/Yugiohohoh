...
class Spell(Component):
    @staticmethod
    def build(pos: vec, data: SpellData, *a):
...
class Trap(Component):
    @staticmethod
    def build(pos: vec, data: TrapData, slot: No[CardSlot] = None):
...
class Monster(Component):
    ...
    @staticmethod
    def build(pos: vec, data: MonsterData, user: 'UserControl', slot: No[CardSlot] = None):
    ...
    def __init__(self, data: MonsterData, user: 'UserControl', slot: No[CardSlot] = None):
        self.data = data
        self.user = user
        self.side = user.side
        self.mySlot = slot
